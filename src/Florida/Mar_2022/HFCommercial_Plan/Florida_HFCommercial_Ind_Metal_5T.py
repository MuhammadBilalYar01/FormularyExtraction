...
LOG_FILE = 'Florida_Health_First_Commercial_Ind_Metal_5T_Mar22.log'
BASE_DATA_FILE = 'Florida_Health_First_Commercial_Ind_Metal_5T_Mar22.pdf'
JSON_FILE = 'Florida_Health_First_Commercial_Ind_Metal_5T_Mar22.json'
PROCESSED_DATA_FILE = 'Florida_Health_First_Commercial_Ind_Metal_5T_Mar22.csv'
RXNORM_MAPPING_FILE = 'Florida_Health_First_Commercial_Ind_Metal_5T-rxnormid_drugs-Mar_22.txt'
...
if __name__ == '__main__':
    ...
    list_header_cols = ['Drug', 'Status', 'Notes']
