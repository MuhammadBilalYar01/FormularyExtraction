...
LOG_FILE = 'Florida_HealthCare_Plan_Non-GrandfatheredCommercials_Mar_22.log'
BASE_DATA_FILE = 'Florida_HealthCare_Plan_Non-GrandfatheredCommercials_Mar_22.pdf'
JSON_FILE = 'Florida_HealthCare_Plan_Non-GrandfatheredCommercials_Mar_22.json'
PROCESSED_DATA_FILE = 'Florida_HealthCare_Plan_Non-GrandfatheredCommercials_Mar_22.csv'
RXNORM_MAPPING_FILE = 'Florida_HealthCare_Plan_Non-GrandfatheredCommercials-rxnormid_drugs-Mar_22.txt'
