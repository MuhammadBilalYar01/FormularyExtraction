...
LOG_FILE = 'Florida_HealthCare_Federal_Exchange_Plan_Mar_22.log'
BASE_DATA_FILE = 'Florida_HealthCare_Federal_Exchange_Plan_Mar_22.pdf'
JSON_FILE = 'Florida_HealthCare_Federal_Exchange_Plan_Mar_22.json'
PROCESSED_DATA_FILE = 'Florida_HealthCare_Federal_Exchange_Plan_Mar_22.csv'
RXNORM_MAPPING_FILE = 'Florida_HealthCare_Federal_Exchange_Plan-rxnormid_drugs-Mar_22.txt'
