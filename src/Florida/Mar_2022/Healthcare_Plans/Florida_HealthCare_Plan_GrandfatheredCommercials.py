...
LOG_FILE = 'Florida_HealthCare_Plan_GrandfatheredCommercials_Mar_22.log'
BASE_DATA_FILE = 'Florida_HealthCare_Plan_GrandfatheredCommercials_Mar_22.pdf'
JSON_FILE = 'Florida_HealthCare_Plan_GrandfatheredCommercials_Mar_22.json'
PROCESSED_DATA_FILE = 'Florida_HealthCare_Plan_GrandfatheredCommercials_Mar_22.csv'
RXNORM_MAPPING_FILE = 'Florida_HealthCare_Plan_GrandfatheredCommercials-rxnormid_drugs-Mar_22.txt'
...
if provider(excluded=['alibaba', 'aws', 'do', 'azure', 'oci']) == 'gcp':
    ...
    BASE_DATA_DIR = '../../../../../data/Florida/Mar_2022'
    IS_ON_GCP = False
...
if __name__ == '__main__':
    ...
    list_header_cols = ['Drug Name', 'Tier', 'Requirements/Limits']
    ...
    drug_types = ['SOLR', 'TABS', 'CAPS', 'SOLN', 'TB24', 'SUSR', 'SUSP', 'CHEW', 'PACK', 'POWD', 'CONC', 
              ...
              'Suppository','Weekly','Suspension','Ointment','Packet','Lotion','Oil','Needle']
    drug_types.extend([x.lower() for x in drug_types])
    page_range = range(9, 66)
    try:
