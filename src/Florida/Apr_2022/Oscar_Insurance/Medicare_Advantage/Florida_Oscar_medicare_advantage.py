...
LOG_FILE = 'Florida_Oscar_Medicare_Adv_Apr_22.log'
BASE_DATA_FILE = 'FL_Oscar_Medicare_advantage_Apr_22.pdf'
JSON_FILE = 'Florida_Oscar_Medicare_advantage_Apr_22.json'
PROCESSED_DATA_FILE = 'Florida_Oscar_Medicare_adv_Apr_22.csv'
RXNORM_MAPPING_FILE = 'Florida_Oscar_Medicare_adv-rxnormid_drugs-Apr_22.txt'
