...
LOG_FILE = 'Florida_MARKETPLACE_Aetna_Better_Health_Apr22.log'
BASE_DATA_FILE = 'Aetna_Health_Exchange_Plan_FL-Apr2022.pdf'
JSON_FILE = 'Florida_MARKETPLACE_Aetna_Better_Health_Apr22.json'
PROCESSED_DATA_FILE = 'Florida_MARKETPLACE_Aetna_Better_Health_Apr22.csv'
RXNORM_MAPPING_FILE = 'Florida_MARKETPLACE_Aetna_Better_Health-rxnormid_drugs-Apr_22.txt'
...
if provider(excluded=['alibaba', 'aws', 'do', 'azure', 'oci']) == 'gcp':
    ...
    BASE_OUTPUT_DIR = '../../../../output/Florida/Aetna'
