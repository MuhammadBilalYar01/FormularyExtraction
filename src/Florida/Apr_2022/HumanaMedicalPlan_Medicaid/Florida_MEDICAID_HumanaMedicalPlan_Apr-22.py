...
LOG_FILE = 'Florida_MEDICAID_HumanaMedicalPlan_Apr22.log'
BASE_DATA_FILE = 'FL_MEDICAID_HumanaMedicalPlan-Apr2022.pdf'
JSON_FILE = 'Florida_MEDICAID_HumanaMedicalPlan_Apr22.json'
PROCESSED_DATA_FILE = 'Florida_MEDICAID_HumanaMedicalPlan_Apr22.csv'
RXNORM_MAPPING_FILE = 'Florida_MEDICAID_HumanaMedicalPlan-rxnormid_drugs-Apr_22.txt'
...
if provider(excluded=['alibaba', 'aws', 'do', 'azure', 'oci']) == 'gcp':
    ...
    BASE_OUTPUT_DIR = '../../../../output/Florida/HumanaMedicalPlan'
