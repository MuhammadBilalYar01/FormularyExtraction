...
LOG_FILE = 'Florida_MEDICAID_AmeriHealth_Apr22.log'
BASE_DATA_FILE = 'FL_MEDICAID_AmeriHealth-Apr2022.pdf'
JSON_FILE = 'Florida_MEDICAID_AmeriHealth_Apr22.json'
PROCESSED_DATA_FILE = 'Florida_MEDICAID_AmeriHealth_Apr22.csv'
RXNORM_MAPPING_FILE = 'Florida_MEDICAID_AmeriHealth-rxnormid_drugs-Apr_22.txt'
...
if provider(excluded=['alibaba', 'aws', 'do', 'azure', 'oci']) == 'gcp':
    ...
    BASE_OUTPUT_DIR = '../../../../output/Florida/AmeriHealth'
