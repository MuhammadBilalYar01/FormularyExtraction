...
LOG_FILE = 'Nevada-Sierra_Health_4Tier_IND_May22.log'
BASE_DATA_FILE = '4 tier IND PDL.pdf'
JSON_FILE = 'Nevada-Sierra_Health_4Tier_IND_May_2022.json'
PROCESSED_DATA_FILE = 'Nevada-Sierra_Health_4Tier_IND-May_22.csv'
RXNORM_MAPPING_FILE = 'Nevada-Sierra_Health_4Tier_IND-rxnormid_drugs-May_22.txt'
