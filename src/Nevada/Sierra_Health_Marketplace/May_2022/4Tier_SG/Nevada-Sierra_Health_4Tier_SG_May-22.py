...
LOG_FILE = 'Nevada-Sierra_Health_4Tier_SG_May22.log'
BASE_DATA_FILE = '4 tier SG.pdf'
JSON_FILE = 'Nevada-Sierra_Health_4Tier_SG_May_2022.json'
PROCESSED_DATA_FILE = 'Nevada-Sierra_Health_4Tier_SG-May_22.csv'
RXNORM_MAPPING_FILE = 'Nevada-Sierra_Health_4Tier_SG-rxnormid_drugs-May_22.txt'
