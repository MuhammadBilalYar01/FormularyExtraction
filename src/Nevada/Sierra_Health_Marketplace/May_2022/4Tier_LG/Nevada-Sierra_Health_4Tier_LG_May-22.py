...
LOG_FILE = 'Nevada-Sierra_Health_4Tier_LG_May22.log'
BASE_DATA_FILE = '4 tier LG.pdf'
JSON_FILE = 'Nevada-Sierra_Health_4Tier_LG_May_2022.json'
PROCESSED_DATA_FILE = 'Nevada-Sierra_Health_4Tier_LG-May_22.csv'
RXNORM_MAPPING_FILE = 'Nevada-Sierra_Health_4Tier_LG-rxnormid_drugs-May_22.txt'
