...
LOG_FILE = 'Nevada_health_plan_4tier_lg.log'
BASE_DATA_FILE = '4 tier LG.pdf'
JSON_FILE = 'Nevada_health_plan_4tier_lg_May_22.json'
PROCESSED_DATA_FILE = 'Nevada_health_plan_4tier_lg_May_22.csv'
RXNORM_MAPPING_FILE = 'Nevada_health_plan_4tier_lg-rxnormid_drugs-May_22.txt'
