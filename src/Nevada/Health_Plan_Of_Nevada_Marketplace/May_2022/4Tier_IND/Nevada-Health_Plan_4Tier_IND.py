...
LOG_FILE = 'Nevada_health_plan_4tier_ind.log'
BASE_DATA_FILE = '4 tier IND PDL.pdf'
JSON_FILE = 'Nevada_health_plan_4tier_ind_May_22.json'
PROCESSED_DATA_FILE = 'Nevada_health_plan_4tier_ind_May_22.csv'
RXNORM_MAPPING_FILE = 'Nevada_health_plan_4tier_ind-rxnormid_drugs-May_22.txt'
