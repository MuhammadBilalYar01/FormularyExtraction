...
LOG_FILE = 'Nevada_health_plan_4tier_essential.log'
BASE_DATA_FILE = '4 tier Essential IS.pdf'
JSON_FILE = 'Nevada_health_plan_4tier_essential_May_22.json'
PROCESSED_DATA_FILE = 'Nevada_health_plan_4tier_essential_May_22.csv'
RXNORM_MAPPING_FILE = 'Nevada_health_plan_4tier_essential-rxnormid_drugs-May_22.txt'
