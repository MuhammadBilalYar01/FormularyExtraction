...
LOG_FILE = 'Nevada_Aetna_Medicaid_Apr22.log'
BASE_DATA_FILE = '2022_Aetna_Health_Exchange_Plan-Apr_2022.pdf'
JSON_FILE = 'Nevada_Aetna_Medicaid_Apr_2022.json'
PROCESSED_DATA_FILE = 'Nevada_Aetna_Medicaid-Apr_22.csv'
RXNORM_MAPPING_FILE = 'Nevada_Aetna_Medicaid-rxnormid_drugs-Apr_22.txt'
...
if provider(excluded=['alibaba', 'aws', 'do', 'azure', 'oci']) == 'gcp':
    ...
    BASE_OUTPUT_DIR = '../../../../output/Nevada/Aetna_Medicaid/Apr_2022'
    BASE_DATA_DIR = '../../../../data/Nevada/Aetna_Medicaid'
    IS_ON_GCP = False
...
def parse_pdf(path, columns, table_headers, page_range, table_config):
    ...
    try:
        ...
        logger.critical("Error in file open: {}".format(e))
...
_drug_tier_map = {"PG": "Preferred Generic", 
