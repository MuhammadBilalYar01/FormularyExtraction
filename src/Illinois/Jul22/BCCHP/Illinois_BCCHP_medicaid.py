...
LOG_FILE = 'Illinois_Blue_Cross_Medicaid_Jul_22.log'
BASE_DATA_FILE = 'Illinois_Blue_Cross_Medicaid_Jul_22.pdf'
JSON_FILE = 'Illinois_Medicaid_Blue_Cross_Community_Health_Plans_Jul_22.json'
PROCESSED_DATA_FILE = 'Illinois_Blue_Cross_Medicaid_Jul_22.csv'
RXNORM_MAPPING_FILE = 'Illinois_Blue_Cross_Medicaid-rxnormid_drugs-Jul_22.txt'
