...
LOG_FILE = 'Illinois_MolinaHC_Apr_22.log'
BASE_DATA_FILE = 'Illinois_MolinaHC_Apr_22.pdf'
JSON_FILE = 'Illinois_MolinaHC_Apr_22.json'
PROCESSED_DATA_FILE = 'Illinois_MolinaHC_Apr_22.csv'
RXNORM_MAPPING_FILE = 'Illinois_MolinaHC-rxnormid_drugs-Apr_22.txt'
...
def process_file_content(df_file_content):
   ...
   # df_page_content['Group'].value_counts(dropna=False)
