...
LOG_FILE = 'Illinois_Aetna_BHOI_Apr_22.log'
BASE_DATA_FILE = 'ABHIL_Formulary_Apr_2022.pdf'
JSON_FILE = 'Illinois_Aetna_BHOI_Apr_22.json'
PROCESSED_DATA_FILE = 'Illinois_Aetna_BHOI_Apr_22.csv'
RXNORM_MAPPING_FILE = 'Illinois_Aetna_BHOI-rxnormid_drugs-Apr_22.txt'
...
if __name__ == '__main__':
    ...
    list_header_cols = ['Prescription Drug Name', 'Drug Tier', 'Coverage Requirements \nand Limits']
    list_cols = ['DrugName', 'DrugTier', 'Requirements_Limits']
    page_range = range(5, 285)
    try:
